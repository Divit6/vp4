...
function draw() {  
  ...
  //write the code for game states 1 and 2
  if (gameState===1){
    dog.addImage(happyDog)
    dog.scale=0.175
    dog.y=250
  ...
  //write the code for game state 3
  if(gameState===3){
 ...
 //write the code for game state 4
 if(gameState===4){
 ...
 //write the code for gamestate 5
if(gameState===5){
 ...
 milkBotltle2.visible=false
  ...
  //write the code for gamestate 6
if(gameState===6){
  dog.y=175
  dog.addImage(garden)
  dog.scale=1
